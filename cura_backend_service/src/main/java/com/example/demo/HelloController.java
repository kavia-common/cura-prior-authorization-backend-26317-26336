package com.example.curabackendservice;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for curabackendservice")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to curabackendservice";
    }
    ...
    public String info() {
        return "Spring Boot Application: curabackendservice";
    }
} 